...
add_arg('-eps',               default=10.,            type=float,     help='regularizer on sinkhorn')
add_arg('-lam_1',               default=1.5,            type=float,     help='regularizer on kernel value k(x,y)')
add_arg('-lam_2',               default=0.,            type=float,     help='regularizer on network output |h(x) - h(y)|')
add_arg('-lam_3',               default=1.5,            type=float,     help='regularizer on kernel value k(x_i,x_j)')
add_arg('-lam_4',               default=0.,            type=float,     help='regularizer on network output |h(x_i) - h(x_j)|')
add_arg('-gamma_1',               default=0.,            type=float,     help='regularizer on Energy')
add_arg('-gamma_2',               default=0.00,            type=float,     help='regularizer on W2')
...
# Directories
storage="/root/"  # remember to revise the path here
